"""
Django settings for gentle_fire_dev_94838 project.
...
ROOT_URLCONF = 'gentle_fire_dev_94838.urls'
...
WSGI_APPLICATION = 'gentle_fire_dev_94838.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_fire_dev_94838 API",
    "DESCRIPTION": "API documentation for gentle_fire_dev_94838 App",
    "VERSION": "v1",
}
